...
import { BlackMainDescription, Faqdescription, FaqWhitedescription, MainHeading, MainWhiteHeading, PlanHeading, SaveHeading, Subblackdescription, SubTagHeading, SubTagWhiteHeading, Subwhitedescription, WhiteMainDescription } from "../../../../Global/GlobalText";
      ...
      <div class="main_plan_div">
        <div class="basic_plan">
          ...
          <div className="price_main_div">
            ...
            <div className="price_main_sub_one">
              <MainHeading>₹10,000 </MainHeading>
        ...
        <div class="basic_plan_two">
          ...
          <div className="price_main_div">
            ...
            <div className="price_main_sub_one">
              <MainWhiteHeading>₹25,000 </MainWhiteHeading>
        ...
        <div class="basic_plan">
          ...
          <div className="price_main_div">
            ...
            <div className="price_main_sub_one">
              <MainHeading>₹20,000 </MainHeading>
              <SubTagHeading className="sub_head">
                {" "}
                <sub>/month</sub>
              </SubTagHeading>
